...
class CnnLstm(nn.Module):
    def __init__(self):
        ...
        self.cnn = CNN(3)
        self.rnn = nn.LSTM(
            input_size=32768,  # 2560, # 15360,   #100224,57344 8192
            hidden_size=16,
            num_layers=1,
            dropout=0.2,
            batch_first=True,
...
class CNNModel(nn.Module):
    def __init__(self):
        ...
        self.conv_layer1 = self._conv_layer_set_single(1, 16, kernel_size=(3, 3, 3), stride=1)
        self.conv_layer2 = self._conv_layer_set_single(16, 32, kernel_size=(3, 3, 3))
        self.conv_layer3 = self._conv_layer_set_single(32, 64, kernel_size=(3, 3, 3))
        self.conv_layer4 = self._conv_layer_set_single(64, 128, kernel_size=(3, 3, 3))
        self.conv_layer5 = self._conv_layer_set_single(128, 256, kernel_size=(3, 3, 3))
        #self.avgpool = nn.AdaptiveAvgPool3d((1, 7, 7))
